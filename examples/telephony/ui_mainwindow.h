...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        verticalLayoutWidget->setGeometry(QRect(9, 14, 671, 361));
        ...
        lstRxMsg = new QListView(verticalLayoutWidget);
        lstRxMsg->setObjectName(QString::fromUtf8("lstRxMsg"));
        QSizePolicy sizePolicy1(QSizePolicy::Expanding, QSizePolicy::Expanding);
        sizePolicy1.setHorizontalStretch(0);
        sizePolicy1.setVerticalStretch(0);
        sizePolicy1.setHeightForWidth(lstRxMsg->sizePolicy().hasHeightForWidth());
        lstRxMsg->setSizePolicy(sizePolicy1);
