...
public:
    ~QMediaRecorderService();

    virtual QAbstractMediaControl* control(const char *name) const = 0;

protected:
    QMediaRecorderService(QObject *parent);
};

#define QMediaRecorderService_iid "com.nokia.Qt.QMediaRecorderService/1.0"
#define QRemoteMediaPlayerService_iid "com.nokia.Qt.QRemoteMediaPlayerService/1.0"

#endif  // QMEDIARECORDERSERVICE_H
