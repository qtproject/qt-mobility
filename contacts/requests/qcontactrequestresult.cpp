 ...
 * This class allows the result of an asynchronous request contacts to be returned
...
/*! Sets the result of the given \a request to be this result, and updates the status of the \a request to \a status */
