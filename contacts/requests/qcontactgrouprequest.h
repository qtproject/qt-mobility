...
#ifndef QCONTACTGROUPREQUEST_H
#define QCONTACTGROUPREQUEST_H
...
class QTCONTACTS_EXPORT QContactGroupRequest : public QContactAbstractRequest
{
    Q_OBJECT
...
public:
    ...
    QContactAbstractRequest::Type type() const {return QContactAbstractRequest::Group;}
    ...
    QList<QContactGroup> groupSelection() const;
    ...
    void clearRestrictions();                                // full group
...
public:
    ...
    QList<QContactGroup> groups();                           // otherwise (full groups)
