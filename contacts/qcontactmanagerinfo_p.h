...
class QContactManagerInfoPrivate : public QSharedData
{
public:
    QContactManagerInfoPrivate() : m_engine(0)
    {
    }

    QContactManagerInfoPrivate(const QContactManagerInfoPrivate& other)
        : QSharedData(other),
