 ...
 * \value ReadOnly Fields with this access constraint set are dynamically modified by the backend.  Users cannot write values to fields of definitions with this access constraint set.
 * \value CreateOnly Fields with this access constraint set are static once created.  Their value cannot be changed dynamically, nor can they be written or read by users.
 */
 ...
 */
AccessConstraint QContactDetailDefinitionField::accessConstraint() const
{
