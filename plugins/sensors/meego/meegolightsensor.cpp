...
char const * const meegolightsensor::id("meego.lightsensor");
bool meegolightsensor::m_initDone = false;

meegolightsensor::meegolightsensor(QSensor *sensor)
...
void meegolightsensor::slotDataAvailable(const Unsigned& data)
{
