...
class Qt7Provider : public QMediaServiceProvider
{
    Q_OBJECT
...
QMediaServiceProvider* Qt7ServicePlugin::create(QString const& key)
{
    if (key == "mediaplayer")
        return new Qt7Provider;
