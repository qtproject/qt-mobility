...
class QDeclarativeGalleryQueryModel : public QAbstractListModel, public QDeclarativeParserStatus
{
    ...
    Q_ENUMS(Result)
    Q_ENUMS(Scope)
    Q_PROPERTY(QAbstractGallery* gallery READ gallery WRITE setGallery CONSTANT)
    ...
    Q_PROPERTY(QStringList properties READ propertyNames WRITE setPropertyNames CONSTANT)
    ...
    Q_PROPERTY(QString rootType READ rootType WRITE setRootType CONSTANT)
    Q_PROPERTY(QVariant rootItem READ rootItem WRITE setRootItem NOTIFY rootItemChanged)
    Q_PROPERTY(Scope scope READ scope WRITE setScope CONSTANT)
