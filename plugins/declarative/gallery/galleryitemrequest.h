...
#ifndef GALLERYITEMREQUEST_H
#define GALLERYITEMREQUEST_H
...
class GalleryItemRequest : public QObject, public QDeclarativeParserStatus
{
    Q_OBJECT
...
QML_DECLARE_TYPE(QTM_PREPEND_NAMESPACE(GalleryItemRequest))
