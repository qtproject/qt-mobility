...
/*!
    ...
    \brief The GalleryRemoveRequest element allows you to remove an item from a
    gallery.

    This is element is part of the \bold {QtMobility.gallery 1.0} module.
*/

GalleryRemoveRequest::GalleryRemoveRequest(QObject *parent)
    : QObject(parent)
{
...
/*!
    ...
    This property holds the gallery a request should remove items from.
*/
...
/*!
    ...
    This property holds the id of the item to remove.
*/
...
void GalleryRemoveRequest::classBegin()
{
}

void GalleryRemoveRequest::componentComplete()
{
    execute();
}

#include "moc_galleryremoverequest.cpp"
