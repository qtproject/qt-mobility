...
#ifndef GALLERYREMOVEREQUEST_H
#define GALLERYREMOVEREQUEST_H
...
class GalleryRemoveRequest : public QObject, public QDeclarativeParserStatus
{
    Q_OBJECT
...
public:
    ...
    GalleryRemoveRequest(QObject *parent = 0);
...
public Q_SLOTS:
    void execute() { m_request.execute(); }
...
QML_DECLARE_TYPE(QTM_PREPEND_NAMESPACE(GalleryRemoveRequest))
