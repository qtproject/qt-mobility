...
class CntVersitMyCardPluginFactory;
class CntVersitMyCardPlugin;

class TestCntVersitMyCardPlugin : public QObject
{
    Q_OBJECT
...
private:
    ...
    CntVersitMyCardPluginFactory* mPluginFactory;
    CntVersitMyCardPlugin* mVersitPrefPlugin;
};
