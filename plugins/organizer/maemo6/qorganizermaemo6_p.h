...
#ifndef QORGANIZERMAEMO6_P_H
#define QORGANIZERMAEMO6_P_H
...
public:
    ...
    QOrganizerItemMaemo6EngineData(const QOrganizerItemMaemo6EngineData& other)
        : QSharedData(other)
    {
    }
...
public:
    static QOrganizerItemMaemo6Engine *createSkeletonEngine(const QMap<QString, QString>& parameters);
