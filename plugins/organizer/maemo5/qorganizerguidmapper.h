...
#ifndef QORGANIZERGUIDMAPPER_H
#define QORGANIZERGUIDMAPPER_H
...
public:
    ...
    QString typeOf(const QString &id);
...
private:
    ...
    QMap< QString, QString > m_itemIdToItemType; // item ID => item type
};
