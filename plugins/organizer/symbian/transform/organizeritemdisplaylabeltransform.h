...
**
****************************************************************************/
#ifndef ORGANIZERITEMDISPLAYLABELTRANSFORM_H_
#define ORGANIZERITEMDISPLAYLABELTRANSFORM_H_

#include "organizeritemdetailtransform.h"

class OrganizerItemDisplayLabelTransform : public OrganizerItemDetailTransform
{
public:
