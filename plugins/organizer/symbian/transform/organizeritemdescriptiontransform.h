...
**
****************************************************************************/
#ifndef ORGANIZERITEMDESCRIPTIONTRANSFORM_H_
#define ORGANIZERITEMDESCRIPTIONTRANSFORM_H_

#include "organizeritemdetailtransform.h"

class OrganizerItemDescriptionTransform : public OrganizerItemDetailTransform
{
public:
