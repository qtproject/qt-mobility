...
#ifndef ORGANIZERITEMPRIORITYTRANSFORM_H_
#define ORGANIZERITEMPRIORITYTRANSFORM_H_

#include "organizeritemdetailtransform.h"

class OrganizerItemPriorityTransform : public OrganizerItemDetailTransform
{
public:
