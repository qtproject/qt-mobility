...
**
****************************************************************************/
#ifndef ORGANIZERITEMTIMESTAMPTRANSFORM_H_
#define ORGANIZERITEMTIMESTAMPTRANSFORM_H_

#include "organizeritemdetailtransform.h"

class OrganizerItemTimeStampTransform : public OrganizerItemDetailTransform
{
public:
