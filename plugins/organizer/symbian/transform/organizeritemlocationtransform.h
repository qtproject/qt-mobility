...
**
****************************************************************************/
#ifndef ORGANIZERITEMLOCATIONTRANSFORM_H_
#define ORGANIZERITEMLOCATIONTRANSFORM_H_

#include "organizeritemdetailtransform.h"

class OrganizerItemLocationTransform : public OrganizerItemDetailTransform
{
public:
