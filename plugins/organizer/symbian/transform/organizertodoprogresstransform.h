...
**
****************************************************************************/
#ifndef ORGANIZERTODOPROGRESSTRANSFORM_H_
#define ORGANIZERTODOPROGRESSTRANSFORM_H_

#include "organizeritemdetailtransform.h"

class OrganizerTodoProgressTransform : public OrganizerItemDetailTransform
{
public:
