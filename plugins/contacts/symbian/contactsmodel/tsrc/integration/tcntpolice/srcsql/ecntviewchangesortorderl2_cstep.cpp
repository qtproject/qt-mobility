...
CECntViewChangeSortOrderL2Step::CECntViewChangeSortOrderL2Step()
/** Each test step initialises it's own name
*/
	{
	// store the name of this test case
	// this is the name that is used by the script file
	//DEF iTestStepName = _L("CECntViewChangeSortOrderL2Step");
...
*/
TInt CECntViewChangeSortOrderL2Step::Exec_SendReceive()
	{
