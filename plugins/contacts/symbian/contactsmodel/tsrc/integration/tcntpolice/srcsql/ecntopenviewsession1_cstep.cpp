...
CECntOpenViewSession1Step::CECntOpenViewSession1Step()
/** Each test step initialises it's own name
*/
	{
	// store the name of this test case
	// this is the name that is used by the script file
	//DEF iTestStepName = _L("CECntOpenViewSession1Step");
...
*/
TInt CECntOpenViewSession1Step::Exec_SendReceive()
	{
	...
	if(iResult_Server == 0)
		...
		if(SR_MESSAGE_ID >= 0)
			...
			TRequestStatus* statusPointer = &status;
			User::RequestComplete(statusPointer, KErrNone);
		    }
		}
