...
CECntOverrideMachineID1Step::CECntOverrideMachineID1Step()
/** Each test step initialises it's own name
*/
	{
	// store the name of this test case
	// this is the name that is used by the script file
	//DEF iTestStepName = _L("CECntOverrideMachineID1Step");
...
*/
TInt CECntOverrideMachineID1Step::Exec_SendReceive()
	{
