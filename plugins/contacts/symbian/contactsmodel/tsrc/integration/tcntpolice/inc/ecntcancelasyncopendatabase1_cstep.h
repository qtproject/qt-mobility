...
#ifndef ECntCancelAsyncOpenDatabase1_H_
#define ECntCancelAsyncOpenDatabase1_H_
...
class CECntCancelAsyncOpenDatabase1Step: public CCapabilityTestStep
	{
...
public:
	...
	CECntCancelAsyncOpenDatabase1Step() ;
