...
#ifndef ECntGetDefaultDatabaseName1_H_
#define ECntGetDefaultDatabaseName1_H_
...
class CECntGetDefaultDatabaseName1Step: public CCapabilityTestStep
	{
...
public:
	...
	CECntGetDefaultDatabaseName1Step() ;
