...
#ifndef ECntViewSortOrderExternalizedSize1_H_
#define ECntViewSortOrderExternalizedSize1_H_
...
class CECntViewSortOrderExternalizedSize1Step: public CCapabilityTestStep
	{
...
public:
	...
	CECntViewSortOrderExternalizedSize1Step() ;
