...
#ifndef ECntSendPluginUidToServer1_H_
#define ECntSendPluginUidToServer1_H_
...
class CECntSendPluginUidToServer1Step: public CCapabilityTestStep
	{
...
public:
	...
	CECntSendPluginUidToServer1Step() ;
