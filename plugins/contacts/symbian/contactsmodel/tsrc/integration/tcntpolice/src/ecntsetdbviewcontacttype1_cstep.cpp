...
CECntSetDbViewContactType1Step::CECntSetDbViewContactType1Step()
/** Each test step initialises it's own name
*/
	{
	// store the name of this test case
	// this is the name that is used by the script file
	//DEF iTestStepName = _L("CECntSetDbViewContactType1Step");
...
*/
TInt CECntSetDbViewContactType1Step::Exec_SendReceive()
	{
