...
CECntWastedSpaceInBytes1Step::CECntWastedSpaceInBytes1Step()
/** Each test step initialises it's own name
*/
	{
	// store the name of this test case
	// this is the name that is used by the script file
	//DEF iTestStepName = _L("CECntWastedSpaceInBytes1Step");
...
*/
TInt CECntWastedSpaceInBytes1Step::Exec_SendReceive()
	{
