...
#ifndef ECntGetContactsMatchingFilter1_H_
#define ECntGetContactsMatchingFilter1_H_
...
class CECntGetContactsMatchingFilter1Step: public CCapabilityTestStep
	{
...
public:
	...
	CECntGetContactsMatchingFilter1Step() ;
