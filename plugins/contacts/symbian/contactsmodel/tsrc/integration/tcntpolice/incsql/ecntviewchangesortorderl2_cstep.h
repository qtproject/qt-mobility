...
#ifndef ECntViewChangeSortOrderL2_H_
#define ECntViewChangeSortOrderL2_H_
...
class CECntViewChangeSortOrderL2Step: public CCapabilityTestStep
	{
...
public:
	...
	CECntViewChangeSortOrderL2Step() ;
