...
#ifndef ECntViewChangeSortOrderL1_H_
#define ECntViewChangeSortOrderL1_H_
...
class CECntViewChangeSortOrderL1Step: public CCapabilityTestStep
	{
...
public:
	...
	CECntViewChangeSortOrderL1Step() ;
