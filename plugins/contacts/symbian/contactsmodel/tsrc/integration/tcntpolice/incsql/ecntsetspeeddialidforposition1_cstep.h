...
#ifndef ECntSetSpeedDialIdForPosition1_H_
#define ECntSetSpeedDialIdForPosition1_H_
...
class CECntSetSpeedDialIdForPosition1Step: public CCapabilityTestStep
	{
...
public:
	...
	CECntSetSpeedDialIdForPosition1Step() ;
