...
#ifndef ECntSetDbViewContactType1_H_
#define ECntSetDbViewContactType1_H_
...
class CECntSetDbViewContactType1Step: public CCapabilityTestStep
	{
...
public:
	...
	CECntSetDbViewContactType1Step() ;
