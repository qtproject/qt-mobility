...
#ifndef ECntGetContactMatchingCriteria1_H_
#define ECntGetContactMatchingCriteria1_H_
...
class CECntGetContactMatchingCriteria1Step: public CCapabilityTestStep
	{
...
public:
	...
	CECntGetContactMatchingCriteria1Step() ;
