...
#ifndef ECntFindAsyncTextDefInit1_H_
#define ECntFindAsyncTextDefInit1_H_
...
class CECntFindAsyncTextDefInit1Step: public CCapabilityTestStep
	{
...
public:
	...
	CECntFindAsyncTextDefInit1Step() ;
