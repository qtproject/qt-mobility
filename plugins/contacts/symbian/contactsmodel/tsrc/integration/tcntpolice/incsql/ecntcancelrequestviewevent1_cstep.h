...
#ifndef ECntCancelRequestViewEvent1_H_
#define ECntCancelRequestViewEvent1_H_
...
class CECntCancelRequestViewEvent1Step: public CCapabilityTestStep
	{
...
public:
	...
	CECntCancelRequestViewEvent1Step() ;
