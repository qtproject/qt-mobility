...
void UT_CntSqlSearch::testPredictiveSearch()
{
    ...
    reference = QString("SELECT contact_id FROM predictivesearch2 WHERE ((nbr>144115188075855871 AND nbr<216172782113783808) AND (nbr2>360287970189639679 AND nbr2<432345564227567616) AND (nbr3>360287970189639679 AND nbr3<432345564227567616)) ORDER BY first_name, last_name ASC;"); 
