...
QGeoRouteCalculateXmlParser::QGeoRouteCalculateXmlParser()
        : m_reader(0)
{
}
...
bool QGeoRouteCalculateXmlParser::parse(QIODevice* source)
{
    if (m_reader)
        delete m_reader;
...
QList<QGeoRoute> QGeoRouteCalculateXmlParser::results() const
{
    return m_results;
}

QString QGeoRouteCalculateXmlParser::errorString() const
{
    return m_errorString;
}

bool QGeoRouteCalculateXmlParser::parseRootElement()
{
    /*
...
bool QGeoRouteCalculateXmlParser::parseRoute(QGeoRoute *route)
{
    /*
...
/*
bool QGeoRouteCalculateXmlParser::parseXsdDateTime(const QString& strDateTime, QDateTime *dateTime, const QString &attributeName)
{
...
bool QGeoRouteCalculateXmlParser::parseXsdDuration(const QString& strDuration, qint32 *durationSeconds, const QString &attributeName)
{
...
bool QGeoRouteCalculateXmlParser::parseManeuver(QGeoRoute *route, QGeoRouteSegment *segment)
{
    /*
...
bool QGeoRouteCalculateXmlParser::parseGeoPoints(const QString& strPoints, QList<QGeoCoordinate> *geoPoints, const QString &elementName)
{
...
bool QGeoRouteCalculateXmlParser::parseBoundingBox(QGeoBoundingBox *bounds)
{
    /*
...
bool QGeoRouteCalculateXmlParser::parseCoordinate(QGeoCoordinate *coordinate, const QString &elementName)
{
    /*
