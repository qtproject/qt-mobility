...
END:VCARD\r\n";
    ...
    propertyAgent.setName(QString("BEGIN"));
    propertyAgent.setValue(QByteArray("VCARD"));
    docAgent.addProperty(propertyAgent);
    propertyAgent.setName(QString("VERSION"));
    propertyAgent.setValue(QByteArray("2.1"));
    docAgent.addProperty(propertyAgent);
    ...
    docAgent.addProperty(propertyAgent);
    propertyAgent.setName(QString("END"));
    propertyAgent.setValue(QByteArray("VCARD"));
    docAgent.addProperty(propertyAgent);
