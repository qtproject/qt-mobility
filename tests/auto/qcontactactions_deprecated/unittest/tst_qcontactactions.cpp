...
Q_EXPORT_PLUGIN2(contacts_testdummystaticactionfactory_deprecated, DummyStaticActionFactory)
Q_IMPORT_PLUGIN(contacts_testdummystaticactionfactory_deprecated)
Q_EXPORT_PLUGIN2(contacts_testdummystaticactionfactorycopy_deprecated, DummyStaticActionFactory)
Q_IMPORT_PLUGIN(contacts_testdummystaticactionfactorycopy_deprecated)
