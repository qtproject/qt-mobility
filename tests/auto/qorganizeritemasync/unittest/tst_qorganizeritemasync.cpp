...
void tst_QOrganizerItemAsync::testDebugStreamOut()
{
    ...
    QTest::ignoreMessage(QtDebugMsg, "QOrganizerAbstractRequest(QOrganizerItemDetailDefinitionFetchRequest(\n* definitionNames=() ,\n* definitions=QMap((\"AudibleReminder\", QOrganizerItemDetailDefinition(name=\"AudibleReminder\",isUnique=false,isEmpty=false,fields=QMap((\"DataUrl\", QOrganizerItemDetailFieldDefinition(dataType=17,allowableValues=() ))(\"RepetitionCount\", QOrganizerItemDetailFieldDefinition(dataType=2,allowableValues=() ))(\"RepetitionDelay\", QOrganizerItemDetailFieldDefinition(dataType=2,allowableValues=() ))(\"SecondsBeforeStart\", QOrganizerItemDetailFieldDefinition(dataType=2,allowableValues=() ))) ))(\"Comment\", QOrganizerItemDetailDefinition(name=\"Comment\",isUnique=false,isEmpty=false,fields=QMap((\"Comment\", QOrganizerItemDetailFieldDefinition(dataType=10,allowableValues=() ))) ))(\"Description\", QOrganizerItemDetailDefinition(name=\"Description\",isUnique=true,isEmpty=false,fields=QMap((\"Description\", QOrganizerItemDetailFieldDefinition(dataType=10,allowableValues=() ))) ))(\"DisplayLabel\", QOrganizerItemDetailDefinition(name=\"DisplayLabel\",isUnique=true,isEmpty=false,fields=QMap((\"Label\", QOrganizerItemDetailFieldDefinition(dataType=10,allowableValues=() ))) ))(\"EmailReminder\", QOrganizerItemDetailDefinition(name=\"EmailReminder\",isUnique=false,isEmpty=false,fields=QMap((\"Attachments\", QOrganizerItemDetailFieldDefinition(dataType=9,allowableValues=() ))(\"Body\", QOrganizerItemDetailFieldDefinition(dataType=10,allowableValues=() ))(\"Recipients\", QOrganizerItemDetailFieldDefinition(dataType=11,allowableValues=() ))(\"RepetitionCount\", QOrganizerItemDetailFieldDefinition(dataType=2,allowableValues=() ))(\"RepetitionDelay\", QOrganizerItemDetailFieldDefinition(dataType=2,allowableValues=() ))(\"SecondsBeforeStart\", QOrganizerItemDetailFieldDefinition(dataType=2,allowableValues=() ))(\"Subject\", QOrganizerItemDetailFieldDefinition(dataType=10,allowableValues=() ))) ))(\"EventTime\", QOrganizerItemDetailDefinition(name=\"EventTime\",isUnique=true,isEmpty=false,fields=QMap((\"AllDay\", QOrganizerItemDetailFieldDefinition(dataType=1,allowableValues=() ))(\"EndDateTime\", QOrganizerItemDetailFieldDefinition(dataType=16,allowableValues=() ))(\"StartDateTime\", QOrganizerItemDetailFieldDefinition(dataType=16,allowableValues=() ))) ))(\"Guid\", QOrganizerItemDetailDefinition(name=\"Guid\",isUnique=true,isEmpty=false,fields=QMap((\"Guid\", QOrganizerItemDetailFieldDefinition(dataType=10,allowableValues=() ))) ))(\"Location\", QOrganizerItemDetailDefinition(name=\"Location\",isUnique=true,isEmpty=false,fields=QMap((\"Label\", QOrganizerItemDetailFieldDefinition(dataType=10,allowableValues=() ))(\"Latitude\", QOrganizerItemDetailFieldDefinition(dataType=6,allowableValues=() ))(\"Longitude\", QOrganizerItemDetailFieldDefinition(dataType=6,allowableValues=() ))) ))(\"Priority\", QOrganizerItemDetailDefinition(name=\"Priority\",isUnique=true,isEmpty=false,fields=QMap((\"Priority\", QOrganizerItemDetailFieldDefinition(dataType=2,allowableValues=(QVariant(int, 0) ,  QVariant(int, 1) ,  QVariant(int, 2) ,  QVariant(int, 3) ,  QVariant(int, 4) ,  QVariant(int, 5) ,  QVariant(int, 6) ,  QVariant(int, 7) ,  QVariant(int, 8) ,  QVariant(int, 9) )  ))) ))(\"Recurrence\", QOrganizerItemDetailDefinition(name=\"Recurrence\",isUnique=true,isEmpty=false,fields=QMap((\"ExceptionDates\", QOrganizerItemDetailFieldDefinition(dataType=259,allowableValues=() ))(\"ExceptionRules\", QOrganizerItemDetailFieldDefinition(dataType=260,allowableValues=() ))(\"RecurrenceDates\", QOrganizerItemDetailFieldDefinition(dataType=259,allowableValues=() ))(\"RecurrenceRules\", QOrganizerItemDetailFieldDefinition(dataType=260,allowableValues=() ))) ))(\"Reminder\", QOrganizerItemDetailDefinition(name=\"Reminder\",isUnique=false,isEmpty=false,fields=QMap((\"RepetitionCount\", QOrganizerItemDetailFieldDefinition(dataType=2,allowableValues=() ))(\"RepetitionDelay\", QOrganizerItemDetailFieldDefinition(dataType=2,allowableValues=() ))(\"SecondsBeforeStart\", QOrganizerItemDetailFieldDefinition(dataType=2,allowableValues=() ))) ))(\"Tag\", QOrganizerItemDetailDefinition(name=\"Tag\",isUnique=false,isEmpty=false,fields=QMap((\"Tag\", QOrganizerItemDetailFieldDefinition(dataType=10,allowableValues=() ))) ))(\"Timestamp\", QOrganizerItemDetailDefinition(name=\"Timestamp\",isUnique=true,isEmpty=false,fields=QMap((\"CreationTimestamp\", QOrganizerItemDetailFieldDefinition(dataType=16,allowableValues=() ))(\"ModificationTimestamp\", QOrganizerItemDetailFieldDefinition(dataType=16,allowableValues=() ))) ))(\"Type\", QOrganizerItemDetailDefinition(name=\"Type\",isUnique=true,isEmpty=false,fields=QMap((\"Type\", QOrganizerItemDetailFieldDefinition(dataType=10,allowableValues=(QVariant(QString, \"Event\") ,  QVariant(QString, \"EventOccurrence\") ,  QVariant(QString, \"Journal\") ,  QVariant(QString, \"Note\") ,  QVariant(QString, \"Todo\") ,  QVariant(QString, \"TodoOccurrence\") )  ))) ))(\"VisualReminder\", QOrganizerItemDetailDefinition(name=\"VisualReminder\",isUnique=false,isEmpty=false,fields=QMap((\"DataUrl\", QOrganizerItemDetailFieldDefinition(dataType=17,allowableValues=() ))(\"Message\", QOrganizerItemDetailFieldDefinition(dataType=10,allowableValues=() ))(\"RepetitionCount\", QOrganizerItemDetailFieldDefinition(dataType=2,allowableValues=() ))(\"RepetitionDelay\", QOrganizerItemDetailFieldDefinition(dataType=2,allowableValues=() ))(\"SecondsBeforeStart\", QOrganizerItemDetailFieldDefinition(dataType=2,allowableValues=() ))) ))) ,\n* itemType=\"Event\",\n* errorMap=QMap() \n))");
    qDebug() << dfr;
