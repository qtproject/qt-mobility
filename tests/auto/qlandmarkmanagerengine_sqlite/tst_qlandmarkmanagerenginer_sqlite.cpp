...
class tst_QLandmarkManagerEnginerSqlite : public QObject
{
    Q_OBJECT
...
private slots:
    ...
    void addCategory() {}
    void updateCategory() {}
    void saveMultipleCategories() {}
    void removeCategory() {}
    void removeMultipleCategories() {}

    void addCategoryToLandmark() {}
    void updateCategoryFromLandmark() {}
    void removeCategoryFromLandmark() {}
...
QTEST_MAIN(tst_QLandmarkManagerEnginerSqlite)
