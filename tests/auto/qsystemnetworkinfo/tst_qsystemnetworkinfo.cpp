...
{
    QSystemNetworkInfo ni;
    if(QSystemNetworkInfo::NoNetworkAvailable != ni.networkStatus(QSystemNetworkInfo::GsmMode)
        && QSystemNetworkInfo::NoNetworkAvailable != ni.networkStatus(QSystemNetworkInfo::CdmaMode)
        && QSystemNetworkInfo::NoNetworkAvailable != ni.networkStatus(QSystemNetworkInfo::WcdmaMode)) {
