...
void tst_QContactDetail::classHierarchy()
{
    ...
    p1.setNumber("123456");
    QVERIFY(!p1.isEmpty());
    QCOMPARE(p1.definitionId(), QContactPhoneNumber::staticType());

    QContactName m1;
    m1.setFirst("Bob");
    QVERIFY(!m1.isEmpty());
    QCOMPARE(m1.definitionId(), QContactName::staticType());
    ...
    QCOMPARE(p2.definitionId(), QContactPhoneNumber::staticType()); // should still be a phone number though
    QVERIFY(p2.isEmpty());
    ...
    QCOMPARE(m2.definitionId(), QContactName::staticType());
    QVERIFY(m2.isEmpty());
    ...
    QCOMPARE(p4.definitionId(), QContactPhoneNumber::staticType());
    QVERIFY(p4.isEmpty());
