...
class tst_QDeclarativeSystemInfo : public QObject
{
    Q_OBJECT
...
void tst_QDeclarativeSystemInfo::tst_availableLanguages()
{
    QDeclarativeGeneralInfo si;
...
void tst_QDeclarativeSystemInfo::tst_hasFeatures_data()
{
...
void tst_QDeclarativeSystemInfo::tst_detailFeatures()
{
//    {
//        QFETCH(QSystemInfo::Feature, feature);
//        QDeclarativeGeneralInfo si;
...
QTEST_MAIN(tst_QDeclarativeSystemInfo)
#include "tst_qdeclarativesysteminfo.moc"
