...
void tst_QMediaRecorder::testAudioEncoderControl()
{
    ...
    audioEncoder->setEncodingOption("PCM", "quality", QVariant(int(QtMedia::NormalQuality)));
    QCOMPARE(audioEncoder->encodingOption("PCM","quality").toInt(), int(QtMedia::NormalQuality));    
