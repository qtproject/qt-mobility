...
#define COMMAND_MESSAGES_QUERY    "mquery"
...
int main(int argc, char *argv[])
{
    ...
    } else if (QString(argv[1]) == QString(COMMAND_MESSAGES_QUERY))
    {
    ...
    //test.testMessageManager_queryCount();
    //test.testMessageManager_queryMessage();
