...
#ifndef QGALLERYTRACKERITEMLISTRESPONSE_P_H
#define QGALLERYTRACKERITEMLISTRESPONSE_P_H
...
class QGalleryTrackerItemListResponse : public QGalleryTrackerListResponse
{
    Q_OBJECT
public:
    QGalleryTrackerItemListResponse(
