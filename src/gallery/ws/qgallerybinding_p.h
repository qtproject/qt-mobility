...
public:
    ...
    QVariant toVariant(const char *buffer, int column) const;

private:
    typedef qint32 (*readInt32)(const char *buffer);
    typedef QString (*readString)(const char *buffer);
    typedef QVariant (*readVariant)(const char *buffer);
