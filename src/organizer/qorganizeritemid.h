...
Q_DECLARE_TYPEINFO(QtMobility::QOrganizerItemLocalId, Q_MOVABLE_TYPE);
Q_DECLARE_TYPEINFO(QtMobility::QOrganizerItemId, Q_MOVABLE_TYPE);

Q_DECLARE_METATYPE(QtMobility::QOrganizerItemLocalId);
Q_DECLARE_METATYPE(QtMobility::QOrganizerItemId);
