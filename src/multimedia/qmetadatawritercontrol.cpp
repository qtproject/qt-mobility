...
/*!
    \fn QVariant QMetaDataWriterControl::metaData(QtMediaServices::MetaData key) const

    Returns the meta-data for the given \a key.
*/

/*!
    \fn void QMetaDataWriterControl::setMetaData(QtMediaServices::MetaData key, const QVariant &value)
