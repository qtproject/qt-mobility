...
#ifndef CONTACTCONNECTION_SIMUATOR_P_H
#define CONTACTCONNECTION_SIMUATOR_P_H
...
class ContactConnection : public QObject
{
    Q_OBJECT
public:
    explicit ContactConnection(MobilityConnection *mobilityCon);
    static ContactConnection *instance();

    void setEngine(QContactSimulatorEngine *engine);
...
private:
    ...
    QContactSimulatorEngine *mEngine;
};
