...
public:
    ...
    static QList<QOrganizerItemActionDescriptor> actionDescriptors(const QString& actionName = QString(), const QString& vendorName = QString(), int implementationVersion = -1);

    /* return a pointer to an implementation of the action identified by the given descriptor */
    static QOrganizerItemAction* action(const QOrganizerItemActionDescriptor& descriptor);
