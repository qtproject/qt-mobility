...
#ifndef QORGANIZERITEMGENDER_H
#define QORGANIZERITEMGENDER_H
...
public:
    ...
    Q_DECLARE_LATIN1_LITERAL(FieldStartDateTime, "StartDateTime");
    ...
    QDateTime startDateTime() const {return variantValue<QDateTime>(FieldStartDateTime);}
    void setEndDateTime(const QDateTime& endDateTime) {setValue(FieldEndDateTime, endDateTime);}
    QDateTime endDateTime() const {return variantValue<QDateTime>(FieldEndDateTime);}
};
