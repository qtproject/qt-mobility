...
symbian {
    ...
    contains(QT_CONFIG,dbus) {
        ...
        PRIVATE_HEADERS += ipc/qremoteservicecontrol_ls_p.h \
                           ipc/objectendpoint_p.h
        SOURCES += ipc/qremoteservicecontrol_ls_p.cpp \
                   ipc/objectendpoint.cpp
    }
}
...
SOURCES += \
        ...
        ipc/proxyobject.cpp \
        ipc/ipcendpoint.cpp \
        ipc/qremoteservicecontrol_p.cpp
