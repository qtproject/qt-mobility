...
#ifndef ICHANNELCHATSTATE_H
#define ICHANNELCHATSTATE_H
...
namespace DBus
{
    ...
    {
        class IChannelChatState : public DBus::IAbstract
        {
            Q_OBJECT
        ...
        public:
            ...
            IChannelChatState(DBus::DBusProxy *proxy);
            explicit IChannelChatState(const DBus::Interfaces::IChannel& mainInterface);
            IChannelChatState(const DBus::Interfaces::IChannel& mainInterface, QObject* parent);
...
Q_DECLARE_METATYPE(DBus::Interfaces::IChannelChatState*)

#endif //ICHANNELCHATSTATE_H
