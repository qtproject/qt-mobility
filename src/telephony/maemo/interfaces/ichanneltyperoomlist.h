...
#ifndef ICHANNELTYPEROOMLIST_H
#define ICHANNELTYPEROOMLIST_H
...
namespace DBus
{
    ...
    {
        class IChannelTypeRoomList : public DBus::IAbstract
        {
            Q_OBJECT
        ...
        public:
            ...
            IChannelTypeRoomList(DBus::DBusProxy *proxy);
            explicit IChannelTypeRoomList(const DBus::Interfaces::IChannel& mainInterface);
            IChannelTypeRoomList(const DBus::Interfaces::IChannel& mainInterface, QObject* parent);
        ...
        Q_SIGNALS:
            void GotRooms(const DBus::Interfaces::RoomInfoList& rooms);
...
Q_DECLARE_METATYPE(DBus::Interfaces::IChannelTypeRoomList*)

#endif //ICHANNELTYPEROOMLIST_H
