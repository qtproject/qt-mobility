...
#ifndef ICHANNELHOLD_H
#define ICHANNELHOLD_H
...
namespace DBus
{
    ...
    {
        class IChannelHold : public DBus::IAbstract
        {
            Q_OBJECT
        ...
        public:
            ...
            IChannelHold(DBus::DBusProxy *proxy);
            explicit IChannelHold(const DBus::Interfaces::IChannel& mainInterface);
            IChannelHold(const DBus::Interfaces::IChannel& mainInterface, QObject* parent);
...
Q_DECLARE_METATYPE(DBus::Interfaces::IChannelHold*)

#endif //ICHANNELHOLD_H
