...
void _registerTypes()
{
    ...
    qDBusRegisterMetaType<Tp::ContactCapabilitiesMap>();
    qDBusRegisterMetaType<Tp::ContactCapabilitiesMapList>();
    qDBusRegisterMetaType<Tp::ContactCapability>();
    qDBusRegisterMetaType<Tp::ContactCapabilityList>();
    qDBusRegisterMetaType<Tp::ContactInfoField>();
    qDBusRegisterMetaType<Tp::ContactInfoFieldList>();
    qDBusRegisterMetaType<Tp::ContactInfoMap>();
    qDBusRegisterMetaType<Tp::ContactLocations>();
    qDBusRegisterMetaType<Tp::ContactPresences>();
    qDBusRegisterMetaType<Tp::CurrencyAmount>();
    qDBusRegisterMetaType<Tp::DBusTubeMember>();
    qDBusRegisterMetaType<Tp::DBusTubeMemberList>();
    qDBusRegisterMetaType<Tp::FieldSpec>();
    qDBusRegisterMetaType<Tp::FieldSpecs>();
    qDBusRegisterMetaType<Tp::HandleIdentifierMap>();
    qDBusRegisterMetaType<Tp::HandleOwnerMap>();
    qDBusRegisterMetaType<Tp::HandlerCapabilities>();
    qDBusRegisterMetaType<Tp::HandlerCapabilitiesList>();
    ...
    qDBusRegisterMetaType<Tp::Location>();
