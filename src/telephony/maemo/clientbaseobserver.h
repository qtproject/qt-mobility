...
#ifndef CLIENTBASEOBSERVER_H
#define CLIENTBASEOBSERVER_H
...
namespace DBus
{
    ...
    class ClientBaseObserver : public virtual ClientBase
    {
        Q_DISABLE_COPY(ClientBaseObserver)

    public:
        virtual ~ClientBaseObserver();
        ...
        virtual void observeChannels(const QDBusObjectPath &accountPath,
                                     ...
                                     const ChannelDetailsList &channelDetailsList,
    ...
    protected:
        ClientBaseObserver(const ChannelClassList &channelFilter);
        ClientBaseObserver(const ChannelClassList &channelFilter,
                bool shouldRecover);
