...
set BUILD_DOCS=yes
set BUILD_TOOLS=yes
set MOBILITY_MODULES=bearer location contacts systeminfo publishsubscribe versit messaging sensors serviceframework multimedia gallery telephony organizer feedback connectivity
